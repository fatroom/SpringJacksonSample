package org.noisyteam.samples.spring.jackson.validator;
...
public class PersonValidatorTest {
    ...
    public void validatePersonWithEmptyName() {
        ...
        assertFalse("There are some global errors during jackson", bindingResult.hasGlobalErrors());
        assertTrue("There aren't field errors during jackson", bindingResult.hasFieldErrors());
    ...
    public void validateFilledPerson() {
        ...
        validator.validate(person, bindingResult);
        assertFalse("There are some global errors during jackson", bindingResult.hasGlobalErrors());
        assertFalse("There are some field errors during jackson", bindingResult.hasFieldErrors());
    }
